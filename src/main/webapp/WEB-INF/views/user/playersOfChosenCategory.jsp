        ...
        <div class="row sidebar">
            ...
            <div class="row sidebar">
                <div class="sidebar-main col-md-24">
                    <form:form class="form-horizontal filter" action="/playersOfChosenCategory" method="GET" modelAttribute="filter" >
                        <custom:hiddenInputs excludeParams=" _formatId, _connectionId, formatId, connectionId, maxPrice, minPrice,categoryIdValue,sampleRate,signalNoise"/>
      ...
      <div class="row">
          <c:forEach items="${page.content}" var="player">
            <div class="col-md-8">
                ...
                <a href="/somePlayer/${player.id}">${player.brand.brand} ${player.productName}</a>
