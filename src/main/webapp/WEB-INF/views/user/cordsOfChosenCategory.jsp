        ...
        <div class="row sidebar">
            ...
            <div class="row sidebar">
                <div class="sidebar-main col-md-24">
                    <form:form class="form-horizontal filter" action="/cordsOfChosenCategory" method="GET"
                               modelAttribute="filter">
                        <custom:hiddenInputs
                                excludeParams=" _connectionId, connectionId, maxPrice, minPrice, categoryId,cordLength"/>
        ...
        <div class="row">
            <c:forEach items="${page.content}" var="cord">
                <div class="col-md-8">
                    ...
                    <div class="row">
                        <div class="col-md-24"><span>Ціна - ${cord.price}</span></div>
                    </div>
                </div>
            </c:forEach>
        </div>
