        ...
        <div class="row sidebar">
            ...
            <div class="row sidebar">
                <div class="sidebar-main col-md-24">
                    <form:form class="form-horizontal filter" action="/headphonesOfChosenCategory" method="GET" modelAttribute="filter" >
                        <custom:hiddenInputs excludeParams="_connectionId, connectionId, maxPrice, minPrice, categoryId"/>
    ...
    <div class="col-md-18">
        ...
        <div class="row">
            <c:forEach items="${page.content}" var="headphone">
                <div class="col-md-8">
                    <img src="/images/headphone/${headphone.id}.jpg?version=${headphone.version}">
                    <a href="/someHeadphone/${headphone.id}">${headphone.brand.brand} ${headphone.productName}</a>
