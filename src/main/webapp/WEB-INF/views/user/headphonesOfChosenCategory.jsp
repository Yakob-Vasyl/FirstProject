        ...
        <div class="row sidebar">
            ...
            <div class="row sidebar">
                <div class="sidebar-main col-md-24">
                    <form:form class="form-horizontal filter" action="/headphonesOfChosenCategory" method="GET"
        ...
        <div class="row">
            <c:forEach items="${page.content}" var="headphone">
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-md-24">
                            <img class="img-responsive"
                                 src="/images/headphone/${headphone.id}.jpg?version=${headphone.version}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-24">
                    ...
                    <div class="row">
                        <div class="col-md-24"><span>Ціна - ${headphone.price}</span></div>
                    </div>
                </div>
            </c:forEach>
        </div>
