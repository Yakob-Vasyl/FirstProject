        ...
        <div class="row sidebar">
            ...
            <div class="row sidebar">
                <div class="sidebar-main col-md-24">
                    <form:form class="form-horizontal filter" action="/speakersOfChosenCategory" method="GET" modelAttribute="filter" >
    ...
    <div class="col-md-18">
        ...
        <div class="row">
            <c:forEach items="${page.content}" var="speakers">
                <div class="col-md-8">
                    <img src="/images/speakers/${speakers.id}.jpg?version=${speakers.version}">
                    <a href="/someSpeakers/${speakers.id}">${speakers.brand.brand} ${speakers.productName}</a>
                    <span>${speakers.price}</span>
                </div>
            </c:forEach>
        </div>
